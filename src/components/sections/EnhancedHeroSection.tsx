      ...
      <div className="relative max-w-7xl mx-auto text-center z-10">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-6 py-3 mb-8 rounded-full bg-gradient-to-r from-primary/10 to-secondary/10 border border-primary/20 backdrop-blur-sm"
          >
            <Sparkles className="w-4 h-4 text-primary" />
            <span className="text-sm font-medium text-foreground">Strux Digital - Beyond Limits</span>
          </motion.div>
        ...
        >
          ...
          <div className="relative group">
            ...
            <Input
              ...
              className="pl-12 pr-4 py-4 text-lg bg-card/50 backdrop-blur-sm border-border/50 rounded-2xl focus:border-primary/50 focus:ring-2 focus:ring-primary/20 transition-all duration-300"
            />
