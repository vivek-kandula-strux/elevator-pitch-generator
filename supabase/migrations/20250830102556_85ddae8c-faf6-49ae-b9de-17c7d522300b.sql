...
-- Add index on generated_pitch for text search optimization
CREATE INDEX IF NOT EXISTS idx_elevator_pitches_generated_pitch_trgm ON elevator_pitches USING gin(generated_pitch gin_trgm_ops);